...
function isActive(url: string) {
  return (_match: match<any>, location: any): boolean => {
    ...
    <div className="side-nav">
      <nav>
        <ul>
          ...
          <li>
            {" "}{/* I'm not sure why the isActive stuff does not work out of the box for this link, but it seems we have to work around it. */}
            <NavLink
              to="/lazy-test/faq?bla=true"
              activeClassName="selected"
              isActive={isActive("/lazy-test")}
            >
              <span className="icon-container">
